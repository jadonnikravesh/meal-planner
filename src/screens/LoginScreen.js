...
function friendlyError(code, message) {
  switch (code) {
    ...
    default:                          return `Login failed (${code ?? message ?? 'unknown'}). Check the browser console for details.`;
  }
}
    ...
    <SafeAreaView style={s.safe}>
      ...
      >
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          ...
          <Ionicons name="sparkles" size={38} color={c.accent} style={s.icon} />
          <Text style={s.title}>Welcome back</Text>
          <Text style={s.subtitle}>Log in to continue tracking your nutrition</Text>
