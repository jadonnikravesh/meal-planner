      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }}>
        ...
        >
          ...
          <View style={{
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 15, fontWeight: '700', color: c.white }}>FitChat AI — Privacy Policy</Text>
          ...
          <Section title="Our Commitment" c={c}>
            <Body c={c}>
              Your privacy matters. This policy explains what data FitChat AI collects, how it's used, and how it's protected. We collect only what we need to make the app work well for you.
            </Body>
          </Section>

          <Section title="1. What Data We Collect" c={c}>
            <Body c={c}>
              We collect the following types of information when you use FitChat AI:
            </Body>
          ...
          <Section title="7. Children's Privacy" c={c}>
            <Body c={c}>
              FitChat AI is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13. If you believe a child has provided us with their information, please contact us so we can remove it.
            </Body>
          </Section>
